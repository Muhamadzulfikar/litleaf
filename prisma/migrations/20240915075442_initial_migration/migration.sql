...
-- CreateTable
CREATE TABLE "TagNovel" (
    "id" SERIAL NOT NULL,
    "tag_id" INTEGER NOT NULL,
    "novel_uuid" TEXT NOT NULL,

    CONSTRAINT "TagNovel_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "TagNovel" ADD CONSTRAINT "TagNovel_tag_id_fkey" FOREIGN KEY ("tag_id") REFERENCES "Tags"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TagNovel" ADD CONSTRAINT "TagNovel_novel_uuid_fkey" FOREIGN KEY ("novel_uuid") REFERENCES "Novel"("uuid") ON DELETE CASCADE ON UPDATE CASCADE;
